...
- Replaced the original vector-based Stack class interface from the cloned repo with the array-based Stack class interface.
...
- The decision to use a topIndex was to help keep track of the stack's top position and in a sense its capacity as well, indicating whether it is full.
- The decision to have -1 represent an empty stack was due to the fact that there are no valid array indices below 0.
